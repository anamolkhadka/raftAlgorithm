...
class RaftServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RequestVote = channel.unary_unary(
                ...
                request_serializer=raft__service__pb2.RequestVoteRequest.SerializeToString,
                response_deserializer=raft__service__pb2.RequestVoteResponse.FromString,
        ...
        self.GetStatus = channel.unary_unary(
                ...
                request_serializer=raft__service__pb2.GetStatusRequest.SerializeToString,
                response_deserializer=raft__service__pb2.GetStatusResponse.FromString,
                _registered_method=True)
        self.GetLog = channel.unary_unary(
                '/raft.RaftService/GetLog',
                request_serializer=raft__service__pb2.GetLogRequest.SerializeToString,
                response_deserializer=raft__service__pb2.GetLogResponse.FromString,
                _registered_method=True)
...
def add_RaftServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RequestVote': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=raft__service__pb2.RequestVoteRequest.FromString,
                    response_serializer=raft__service__pb2.RequestVoteResponse.SerializeToString,
            ),
            ...
            'GetStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetStatus,
                    request_deserializer=raft__service__pb2.GetStatusRequest.FromString,
                    response_serializer=raft__service__pb2.GetStatusResponse.SerializeToString,
            ),
            'GetLog': grpc.unary_unary_rpc_method_handler(
                    servicer.GetLog,
                    request_deserializer=raft__service__pb2.GetLogRequest.FromString,
                    response_serializer=raft__service__pb2.GetLogResponse.SerializeToString,
            ),
    }
...
class RaftService(object):
    ...
    def RequestVote(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/raft.RaftService/RequestVote',
            raft__service__pb2.RequestVoteRequest.SerializeToString,
            raft__service__pb2.RequestVoteResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/raft.RaftService/GetStatus',
            raft__service__pb2.GetStatusRequest.SerializeToString,
            raft__service__pb2.GetStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetLog(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/raft.RaftService/GetLog',
            raft__service__pb2.GetLogRequest.SerializeToString,
            raft__service__pb2.GetLogResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
