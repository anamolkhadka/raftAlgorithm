...
class GetStatusResponse(_message.Message):
    __slots__ = ("state", "current_term", "voted_for", "leader_id")
    ...
    voted_for: int
    leader_id: int
    def __init__(self, state: _Optional[str] = ..., current_term: _Optional[int] = ..., voted_for: _Optional[int] = ..., leader_id: _Optional[int] = ...) -> None: ...
